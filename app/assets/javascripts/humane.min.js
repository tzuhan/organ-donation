! function(t, e, i) {
    ...
    return n.prototype = {
        ...
        _run: function() {
            if (!this._animating && this.queue.length && this.el) {
                ...
                var t = this.queue.shift(),
                    e = i.config(t.clickToClose, this.clickToClose);
        ...
        _setOpacity: function(t) {
            ...
            } catch (e) {} else this.el.style.opacity = String(t)
        },
        _showMsg: function() {
            var t = i.config(this.currentMsg.addnCls, this.addnCls);
            if (i.transSupport) this.el.className = this.baseCls + " " + t + " " + this.baseCls + "-animate";
            else {
                var e = 0;
        ...
        _hideMsg: function() {
            var t = i.config(this.currentMsg.addnCls, this.addnCls);
            if (i.transSupport) this.el.className = this.baseCls + " " + t, i.on(this.el, i.vendorPrefix ? i.vendorPrefix + "TransitionEnd" : "transitionend", this.transEvent);
            else var e = 1,
            n = this, s = setInterval(function() {
